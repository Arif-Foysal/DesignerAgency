...
<section class="py-24 relative">
                ...
                <div class="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
                    <div class="w-full flex-col justify-center items-start gap-8 flex">
                        <div class="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                            <h2
                                class="text-gray-900 text-5xl font-bold font-manrope leading-normal lg:text-start text-center">
                                Empowering Each Other to Succeed</h2>
                            <p class="text-gray-500 text-base font-medium leading-relaxed lg:text-start text-center">
                    ...
                    <button onclick="window.location.href='contact.php'"
                        ...
                        <span class="px-1.5 text-white text-base font-medium leading-6">Contact Us</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
            ...
            Visit our creative space and explore innovative designs that bring ideas to life. Let’s collaborate on your next big project!
            </p>
        </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-4">
                        ...
                        <dd class="mt-2 text-base text-gray-500">
                            5th Ave, Prince George<br>
                            British Columbia, USA 3806
                        </dd>
                    </div>
                </div>
